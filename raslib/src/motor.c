 ...
 * @return Pointer to an initialized tMotor, can be used by the SetMotor
 * function
 */
 ...
 * @param speed Float on range [-1, 1] where -1 means maximum backward speed and
 * 1 means maximum forward speed
 */
void SetMotor(tMotor *mtr, float speed) { mtr->SetMotor(mtr, speed); }
