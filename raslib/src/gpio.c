...
const unsigned long PIN_PORTS[PORT_COUNT] = {GPIO_PORTA_BASE, GPIO_PORTB_BASE,
...
void PullUpPin(tPin pin) {
  GPIOPadConfigSet(PORT_VAL(pin), PIN_VAL(pin), GPIO_STRENGTH_2MA,
...
static void CallOnPinType(tCallback callback, void *data, tPin pin,
                          unsigned long type) {
