...
static const int8_t spiLookupByCLK[PIN_COUNT] = {
    [PIN_A2] = 0, [PIN_F2] = 1, [PIN_B4] = 2, [PIN_D0] = 3, [0] = -1,
};

static const tPin indexToMOSI[SPI_COUNT] = {PIN_A5, PIN_F1, PIN_B7, PIN_D3};

static const tPin indexToMISO[SPI_COUNT] = {PIN_A4, PIN_F0, PIN_B6, PIN_D2};
...
static const uint8_t indexToPins[SPI_COUNT] = {
    GPIO_PIN_2 | GPIO_PIN_4 | GPIO_PIN_5, GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2,
    GPIO_PIN_4 | GPIO_PIN_6 | GPIO_PIN_7, GPIO_PIN_0 | GPIO_PIN_2 | GPIO_PIN_3};
...
tBoolean SPIRequestUS(tSPI *spi, tPin csl, const uint32_t *sendData,
...
tBoolean SPIRequest(tSPI *spi, tPin csl, const uint32_t *sendData,
                    unsigned int sendLen, uint32_t *recData,
                    unsigned int recLen, float wait) {
