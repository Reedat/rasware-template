...
static tPWMModule modBuffer[PWM_MODULE_COUNT] = {
    {WTIMER0_BASE, SYSCTL_PERIPH_WTIMER0, INT_WTIMER0A, TIMER_A,
     &WTIMER0_CFG_R},
    {WTIMER0_BASE, SYSCTL_PERIPH_WTIMER0, INT_WTIMER0B, TIMER_B,
     &WTIMER0_CFG_R},
    {WTIMER1_BASE, SYSCTL_PERIPH_WTIMER1, INT_WTIMER1A, TIMER_A,
     &WTIMER1_CFG_R},
    {WTIMER1_BASE, SYSCTL_PERIPH_WTIMER1, INT_WTIMER1B, TIMER_B,
     &WTIMER1_CFG_R},
    {WTIMER2_BASE, SYSCTL_PERIPH_WTIMER2, INT_WTIMER2A, TIMER_A,
     &WTIMER2_CFG_R},
    {WTIMER2_BASE, SYSCTL_PERIPH_WTIMER2, INT_WTIMER2B, TIMER_B,
     &WTIMER2_CFG_R},
    {WTIMER3_BASE, SYSCTL_PERIPH_WTIMER3, INT_WTIMER3A, TIMER_A,
     &WTIMER3_CFG_R},
    {WTIMER3_BASE, SYSCTL_PERIPH_WTIMER3, INT_WTIMER3B, TIMER_B,
     &WTIMER3_CFG_R},
    {WTIMER4_BASE, SYSCTL_PERIPH_WTIMER4, INT_WTIMER4A, TIMER_A,
     &WTIMER4_CFG_R},
    {WTIMER4_BASE, SYSCTL_PERIPH_WTIMER4, INT_WTIMER4B, TIMER_B,
     &WTIMER4_CFG_R},

    // Used by time.h
    //    {WTIMER5_BASE, SYSCTL_PERIPH_WTIMER5, INT_WTIMER5A, TIMER_A,
    //    &WTIMER5_CFG_R}, {WTIMER5_BASE, SYSCTL_PERIPH_WTIMER5, INT_WTIMER5B,
    //    TIMER_B, &WTIMER5_CFG_R},
};
...
static void InitializePWMModule(tPWMModule *mod, tPWM *pwm) {
  ...
  TimerConfigure(mod->BASE, TIMER_CFG_SPLIT_PAIR | *mod->CFG_R |
